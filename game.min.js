...
hideCharacter();
intro.style.display = 'block';
intro.classList.add('centered-text'); 
...
onNextClick(() => {
intro.classList.remove('centered-text'); 
showArchetype();
});
}
const endings = [
...
const archetypes = [
{ id: 0, name: 'aesthete', traits: [1, 2, 0, 3, 3, 0, 3, 0] },      
{ id: 1, name: 'ninja',   traits: [0, 3, 3, 0, 0, 3, 2, 1] },       
{ id: 2, name: 'punk',    traits: [3, 0, 0, 2, 3, 0, 0, 3] },       
{ id: 3, name: 'skull',   traits: [2, 1, 0, 3, 1, 2, 3, 0] },       
{ id: 4, name: 'lips',    traits: [0, 3, 0, 3, 0, 2, 3, 1] },       
{ id: 5, name: 'bird',    traits: [1, 2, 3, 0, 0, 3, 2, 0] },       
{ id: 6, name: 'battery', traits: [2, 1, 1, 2, 1, 1, 1, 3] },       
{ id: 7, name: 'ice',     traits: [1, 2, 0, 3, 1, 1, 0, 3] }        
];
const userVector = [
state.extroversion,
state.introversion,
